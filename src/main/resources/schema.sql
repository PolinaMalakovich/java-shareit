...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    start_date TIMESTAMP WITHOUT TIME ZONE CHECK(start_date > now() AND start_date < end_date),
    end_date TIMESTAMP WITHOUT TIME ZONE CHECK(end_date > now() AND end_date > start_date),
